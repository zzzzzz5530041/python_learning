...
def drawPlanets(planetIn):
    ...
    pygame.draw.circle(screen, planetIn.getColor(), [planetIn.getX(), planetIn.getY()], planetIn.getWidth(),
                       planetIn.getWidth())
    if planetIn.hasRings() == True:
        pygame.draw.circle(screen, solarColorPalette.white, [planetIn.getX(), planetIn.getY()], planetIn.getWidth() + 5,
                           1)
